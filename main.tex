...
\hypersetup{
  ...
  linkcolor   = corlink,
  urlcolor    = corlink,
  pdftitle    = {Statistical analysis of areal quantities},
...
\newcommand{\lspac}{1.25}  % this affects only the main text, not footnotes, captions or tables
...
% For the title page
\title{Statistical analysis of areal quantities through permutation}
...
\cleardoublepage \include{20areal}
\cleardoublepage \include{40permutation}
\cleardoublepage \include{50combination}
