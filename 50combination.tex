...
The above results are shown in Figure~\ref{fig:comb:pain}. Cluster-level maps that can directly be compared to the original findings of \citet{Brooks2005} are shown in Appendix~\ref{sec:supplmat}.
